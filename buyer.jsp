<%-- 
    Document   : buyer
    Created on : 28 Nov, 2020, 10:21:22 AM
    Author     : h
--%>
...
.foot-lnk{
	...
	<div class="login-html">
		...
		<div class="login-form">
                    <form action="buyerlog" method="POST">
			...
			<div class="sign-up-htm">
				...
				<div class="group">
					<label for="pass" class="label">Mobile Number</label>
                                        <input id="mobile" type="text" name="mobile" class="input" data-type="text">
				</div>
				<div class="group">
					...
					<label for="country" class="label">Country</label>
                                        <input id="country" type="text" name="country" class="input">
				</div>
                                <div class="group">
