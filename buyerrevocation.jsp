...
.button:hover span:after {
  ...
  right: 0;
    ...
    <body Background="images/img7.jpg">   
        <center>
            <form name="form1" method="post" action="buyerdelete">
         <br>
           </br>
           <table width="" border="0">
                <tr>
                    <td>
                        <div align="center">
                            <font size="10" face="Lucida Calligraphy">Buyer Revocation</font></div>
                    </td>
                </tr>
            </table>
           <p>
       ...
       <div align="center"><font size="4" face="Californian FB" color="#ffffff">
            <h1>HERE THE BUYER LIST</h1></font>
        </div>
        <center>
        <table width="250" border="0">
            <tr>
                <td>
                    <div align="center"><font size="6" face="Chiller">Buyer List:</font></div>
           ...
           con=DriverManager.getConnection("jdbc:mysql://localhost:3306/real","root","password");
           st=con.createStatement();
           String qry="select username from buyer";
