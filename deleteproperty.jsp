...
.button:hover span:after {
  ...
  right: 0;
    ...
    <body Background="images/img7.jpg">   
        <center>
            <form name="form1" method="post" action="propertyrevocation">
         <br>
           </br>
           <table width="" border="0">
                <tr>
                    <td>
                        <div align="center">
                            <font size="10" face="Lucida Calligraphy">Property Revocation</font></div>
                    </td>
                </tr>
            </table>
           <p>
       ...
       <div align="center"><font size="4" face="Californian FB" color="#ffffff">
            <h1>HERE THE PROPERTY LIST</h1></font>
        </div>
        <center>
        <table width="250" border="0">
            <tr>
                <td>
                    <div align="center"><font size="6" face="Chiller">Property List:</font></div>
           ...
           String qry="select location from property";
